	...
	return (
		<>
			<div className='container max-w-7xl mx-auto px-8 md:px-20 pt-20 '>
				...
				<div className='text-[#7B61FF] pt-6 font-semibold text-3xl'>Pricing</div>
					...
					{Price.map((i, d) => (
						...
						>
							...
							<div className='flex m-4 items-baseline'>
								...
								<span className='ml-1 text-2xl font-medium text-[#6B7280]'>{i.year}</span>
							</div>
							{/* <div className=""> */}
				...
				<div className='md:flex pt-8 items-center itemcount'>
					...
					<div className=' '>
						<p className='text-2xl  font-normal'>
							Basic
							<span className='text-sm  font-medium pl-2 text-[#4F46E5] '> FREE</span>
						</p>
					...
					<>
						...
						<div className='pt-10 grid md:grid-cols-2  grid-col-1 gap-4'>
							<div className=' mb-2 mr-5 md:mr-2  rounded-xl border-2 shadow-md  border-[#7B61FF]'>
								<img src='/images/star.png ' alt='Vector' className='pt-5 px-5 py-5'></img>
								<div className='text-base font-semibold pl-5'>Create a Single NFT</div>
								<p className='font-normal text-base px-5 py-5 itemcount'>
									This will generate a tokenset based on the preview you have seen in the gallery.
									What you’ve seen is what you get. Voomio adds randomization to the token number.
								</p>
								<button
									// onClick={() => { handleSelect() }}
									type='button'
							...
							<div className=' mb-2 mr-5 md:mr-2 rounded-xl border-2 shadow-md  border-[#7B61FF]'>
								...
								></img>
								<div className='text-base font-semibold pl-5'>Create an NFT Set</div>
								<p className='font-normal text-base px-5 py-5 itemcount'>
									This will create a set based on your rules and rarity settings, but isn’t what
									you saw in the gallery. This will guarantee higher randomization and less bias.
								</p>
								<button
									type='button'
									id='btnSelect'
