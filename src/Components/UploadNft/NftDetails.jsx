...
const NftDetails = ({ closeModal }) => {
   ...
   return (
      <>
         ...
         <div id="popup-modal" tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-10 right-0 left-0 z-50 md:inset-0 h-modal md:h-full py-8 items-center justify-center flex transition duration-700 ease-in-out" aria-modal="true" role="dialog">
            <div class="relative w-full max-w-xl h-full md:h-auto bg-white rounded-xl shadow-2xl ">
               <div class="relative rounded-lg shadow px-4">
                  <button type="button" class="absolute top-1 right-3 text-[#6549F6] bg-transparent rounded-lg text-sm ml-auto inline-flex items-center " data-modal-toggle="popup-modal" onClick={() => { closeModal(false) }}>
               ...
               <div className='flex gap-10 justify-center mt-6'>
                  <div>
                     <img src="/images/monkey.png" alt="" className='h-64 w-64 rounded-lg' />
                  </div>
                  <div className='w-64'>
                     ...
                     <div>
                        {
                           attributes.map(i => {
                              return (<div className='flex gap-2 justify-between text-base'>
                     ...
                     <div className='flex justify-end my-5'>
                        <div id='createButton' className='create-button flex items-center gap-2 text-white px-8 py-2 rounded-3xl cursor-pointer'>
                           <i id='plusXmark' className="fa-solid fa-plus"></i>
                           <div id='createCancel' onClick={openRule}>Create Rule</div>
                        </div>
                     </div>
               ...
               <div id='ruleCreation' className='bg-[#F4EEFF] mt-5 pl-3 hidden'>
                  <div className='text-[#6549F6] font-semibold text-lg'>Create A Rule</div>
                  <div className='font-normal text-base pt-2'>After you create a rule any existing tokens will be regenerated.</div>
