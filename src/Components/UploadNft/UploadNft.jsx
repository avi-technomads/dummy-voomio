...
import { Route, Switch, Navigate, useNavigate } from "react-router-dom";
          ...
          <div className="">
            ...
            <div className="flex justify-center">
              <div className='border-[#6549F6] border-4 rounded-2xl xl:w-[1000px] flex flex-col items-center justify-center py-10'>
                ...
                >
                  <div>
                    <div className="flex justify-center items-center mt-3"><i class="fa-solid fa-circle-check fa-4x text-[#87FDDD]"></i></div>
